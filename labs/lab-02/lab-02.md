...
Para informar o ambiente de compilação que estamos usando a TM4C129 é necessário adicionar `PART_TM4C1294NCPDT` aos preprocessor symbols, nas opções do Target.
